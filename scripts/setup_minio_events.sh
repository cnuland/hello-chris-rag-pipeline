...
: "${WEBHOOK_TARGET_ID_IN_MINIO:?Error: WEBHOOK_TARGET_ID_IN_MINIO is not set. This is the ID used in MinIO server's WEBHOOK notification env vars (e.g., HTTPBRIDGE).}"
