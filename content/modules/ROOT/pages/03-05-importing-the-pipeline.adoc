...
5.  (Optional) You can add a description, such as: `A pipeline to fetch closed ServiceNow incidents and ingest them into a Milvus vector database.`
...
8.  After a moment, you will be taken to the pipeline's details page. This page shows you the static graph of the pipeline's components and their dependencies.
+
[.bordershadow]
